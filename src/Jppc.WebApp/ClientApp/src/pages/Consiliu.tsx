...
class SbStanga extends React.Component {
  public render () {
    return (
      <div>
            <Typography variant="h6" gutterBottom><b>Director</b></Typography>
            <Typography gutterBottom><i>Dr. </i><b>Sorin CACE</b></Typography>
            ...
            <Typography gutterBottom><i>Prof. univ. dr. </i><b>Stefan COJOCARU</b>, Universitatea "Alexandru Ioan Cuza" Iasi</Typography>
...
(SbStanga as React.ComponentClass<Props>).propTypes = {
  classes: PropTypes.object.isRequired,
} as any;

export default withStyles(styles)(SbStanga);
